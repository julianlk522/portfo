...
function AboutSpiral({ darkMode, spiralControls, handControls }) {
	const spiralVariants = {
		...
		visible: {
			...
			pathLength: 1,
			strokeOpacity: [null, 0.15, 0, 0.1, 0],
			transition: {
				type: 'spring',
				duration: 3,
			},
	...
	return (
		<motion.svg
			id='aboutSpiral'
			className='absolute top-0 left-[-25%] w-[150%] text-primaryOrange blur-[2px] md:top-aboutSpiralTopLg'
			width='400'
			height='400'
			viewBox='3 3 501 531'
			fill='none'
		...
		>
			<motion.path
				...
				stroke='currentcolor'
				strokeOpacity={darkMode ? '0.03' : '0.1'}
				strokeWidth='0'
				strokeLinecap='round'
				initial='initial'
