...
function ChatStationDetails({ darkMode }) {
	return (
		...
		>
			<header className='mb-32 flex flex-col items-center justify-between md:flex-row'>
				<div id='headerText' className='md:w-1/2'>
					...
					<div className='flex h-auto flex-col space-y-8 px-8 md:w-4/5 md:pr-0'>
						<p></p>
						<p>
							ChatStation is a messaging platform that allows any
							user with an account to find other users with
							accounts and begin communicating. Users can easily
							assign nicknames to any other user to be displayed
							during their conversations together, as well as
							choose an avatar image from a set of options that
							other users will see during their conversation.
						</p>
						<p>
							For me this project was mostly made with the goal in
							mind of getting comfortable using a relational
							database alongside a React.js frontend, though I
							also wanted to challenge myself to build a
							functional full-stack application using only a UI
							sketch as a reference.
						</p>
					</div>
			...
			>
				<section className='mb-32 flex h-auto flex-col md:mb-0 md:w-1/2'>
					...
					<div className='space-y-8 px-8 md:max-w-[80%] md:pr-0'>
						<p>
							The inspiration from ChatStation&apos;s design came
							from a still screenshot of another chat messaging
							application UI without reference to guide many of
							the key underlying features powering the full
							experience (user authentication, database selection
							and management, live deployment, etc.).
						</p>
						<figure
							id='mockupImgWrapper'
						...
						>
							...
							<figcaption className='mt-4 text-xs'>
								Mockup used for the basis of ChatStation&apos;s
								layout
							</figcaption>
						</figure>
						<p>
							With that said, I&apos;m pretty happy with how
							everything came out, and having the experience of
							growing ChatStation from a barebones UI snapshot has
							given me more confidence moving forward with other
							projects using little initial guidance.
						</p>
					</div>
				</section>
				<section className='flex h-auto flex-col md:w-1/2'>
					...
					<div className='space-y-8 px-8 md:max-w-[80%] md:pr-0'>
						<p>
							When I configured ChatStation to run through Docker
							and Docker-Compose, I had a much harder time
							...
							, another one of my projects which uses MongoDB for
							its databasing.
						</p>
						<p>
							Unlike in a containerized application using MongoDB,
							one using MySQL requires that a dump of the existing
							database be placed in the{' '}
							<i>/docker-entrypoint-initdb.d</i> directory to be
							recreated upon container startup, as described in{' '}
							<a
								className='underline'
						...
						>
							...
							<figcaption className='mt-4 text-xs'>
								...
								also required a dump and import of the existing
								MySQL database
							</figcaption>
						</figure>
						<p>
							I found this somewhat unintuitive, though I&apos;m
							probably just spoiled by the simplification that
							MongoDB grants to its users. In any case, the
							experience of manually configuring a database dump
							and recreation in Docker will no doubt prove useful
							in the future while using MySQL databases in other
							applications.
						</p>
						<p>
							I also had issues deploying the compiled JavaScript
							version of this TypeScript application due to a
							...
							suggests that the behavior is intended as a way to
							hoist exports so that they are immediately visible
							as members of the containing module.
						</p>
						<div
						...
						<p>
							...
							than the TypeScript development team - surely they
							had a good reason for implementing this pattern. But
							I can say that manually overriding the compiled code
							and removing the initial all-inclusive assignment to
							<i>void 0</i> resulted in the correct assignment of
							environment variable values needed to allow
			...
			<div
				id='mainImgWrapper'
				className='my-32 mx-auto flex max-h-[60vh] w-full flex-col justify-center text-center lg:w-fit'
				style={
					darkMode
						? {
								boxShadow:
